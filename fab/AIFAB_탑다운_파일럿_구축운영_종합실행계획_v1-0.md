...
|---|---|---|---|---|
| 7월 3주 | 7/13~7/17 | 계정 체계·Landing Zone 점검, 골든 패스 설계 착수 | 파일럿 헌장·예외 규정 초안(기획안 §2 주체 조항 보완), 결정 권한자 지명 | **7/17 착수 보고** — 계획·예산·R&R 승인 |
...
| 8월 3주 | 8/17~8/21 | 참여자 계정·권한 프로비저닝(Entra ID) | 온보딩 1주차: Claude Code·골든 패스 교육(2일), 챔피언 지정 | 주간 진척 보고 |
...
| 9월 2주 | 9/7~9/11 | 파이프라인 운영 지원 | 스프린트 W2, **9/11 Gate 1 중간 심사** | 9/14(월) Gate 1 판정 통보(SLA 48h) |
...
| 10월 1주 | 9/28~10/2 | 이관 7단계 착수 / 폐기 계정 Frozen | 최종 보고서 작성 | **10/2 최종 결과 보고** — 확대(2차 코호트) 여부 |

## 3. R&R (RACI)

> R=실행, A=최종 책임, C=협의, I=통보

| 활동 | AI Board (운영 전담 2~5명 포함) | AI 인프라팀 | 정보보호팀 | 멘토 | 챔피언 | 부서장 | 시티즌 개발자 |
|---|---|---|---|---|---|---|---|
| 파일럿 헌장·예외 규정 | **R/A** | C | C | I | — | I | — |
| 골든 패스·파이프라인 구축 | C | **R/A** | C | C | — | — | — |
| KPI·Go/No-Go 산식 수립·동결 | **R/A** | C | C | C | — | I | I |
| 모집·선발(2단계 심사) | **A**/R(1차) | R(2차) | C | R(2차) | — | C(승인) | 지원 |
| 온보딩·교육 | **A**/R | R(계정) | I | C | R | I | R |
| 스프린트 일일 운영 | **A** + R(기술상담) | C | — | R(방향성 점검) | R(스탠드업) | I | **R** |
| Gate 0·1 심사 | **A**/R | C | — | R | — | I | 발표 |
| Gate 2 — 자동 검사·3-lane 리뷰 | R(기술상담 전담 1차 리뷰) | R | R(Red lane) | C | — | — | 제출 |
| Gate 2 — 배포 최종 승인 | **A** | R(배포 실행) | **A**(보안) | — | — | — | — |
| 데모데이 | **A**/R | C | — | C | C | I(참석) | 발표 |
| Go/No-Go 판정·출구 결정 | **A**/R(산정) | C | C | C | — | C | I |
| 이관(7단계 격상) / 리소스 회수 | C | **R/A** | C | C | — | I(이관 수용) | 인수인계 |
| 주간·마일스톤 보고 | **R/A** | C | — | — | — | I | — |
...
### Track A — 시스템 구축
- [ ] 골든 패스 6대 템플릿 완비 (ECS on Fargate / Lambda / RDS / 비용태그 / 관측성 / Secrets Manager)
- [ ] 폼 입력 → CI/CD·IAM·모니터링 포함 레포 자동 생성 → 스테이징 배포 **1시간 이내** (비개발자 드라이런 통과)
- [ ] SAST·시크릿 검출 파이프라인 내장 (Critical/High 0건 게이트 동작 확인)
...
| 보고 | 주기 | 작성 | 수신 | 내용 |
|---|---|---|---|---|
| 주간 진척 보고 | 매주 금 | AI Board | 스폰서·경영진 | 트랙별 진척률, 이슈·리스크, 차주 계획 (1페이지) |
...
- 상세 시나리오: `AIFAB_탑다운_파일럿_구축_타임라인_운영시나리오_실무_v1-0.md`
- 스프린트 일별 시간표: `AIFAB_3주_스프린트_운영시간표_실무_v1-0.md`
- 경영 보고용: `AIFAB_탑다운_파일럿_구축_타임라인_경영보고_v1-0.md`, `AIFAB_3주_스프린트_운영시간표_경영보고_v1-0.md`
